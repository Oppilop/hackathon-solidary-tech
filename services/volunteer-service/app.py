...
def get_volunteers_by_ngo(ngo_id):
    try:
        # Operação Scan simplificada (herdada do código-base do Hackathon).
        # Em produção, um GSI por ngo_id evitaria o custo de varrer a tabela —
        # ver docs/fase5/FINOPS.md, seção "Recomendações de otimização".
        response = table.scan(
