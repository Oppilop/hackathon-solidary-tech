...
resource "aws_db_instance" "this" {
  ...
  # Backups automáticos diários + PITR nativo do RDS dentro da janela de
  # retenção. É o que sustenta o RPO das doações declarado no PCN.
